<%@page import="com.example.bootweb01.ScorerankTO"%>
...
<%	
	...
	ArrayList<ScorerankTO> scorerankdata = (ArrayList)request.getAttribute( "scorerankdata" ); //득점순위 값
	...
	for( ScorerankTO to : scorerankdata ){
		String seq = to.getSeq();
		String ranking = to.getRanking();
		String player = to.getPlayer();
		String teamname = to.getTeamname();
		String play = to.getPlay();
		String goal = to.getGoal();
		String list = to.getList();
		
		sbHtml2.append( "<tr>" );
		sbHtml2.append( "<th>" + ranking + "</th>");
		sbHtml2.append( "<td>" + player + "</td>");
		sbHtml2.append( "<td>" + teamname + "</td>");
		sbHtml2.append( "<td>" + play + "</td>");
		sbHtml2.append( "<td>" + goal + "</td>");
		sbHtml2.append( "</tr>" );
	}
%>
	...
	<div class="album py-5 bg-light">
	    <div class="container">
	    	<div class="btn-group btn-group-lg">
		    	<input type="button" value="클럽" class="btn btn-secondary my-2 my-sm-0" style="cursor: pointer;" onclick="location.href='./league.do?smallcode=<%=listrecord %>'" />
				<input type="button" value="팀순위" class="btn btn-secondary my-2 my-sm-0" style="cursor: pointer;" onclick="location.href='./Rank.do?list=<%=listrecord %>'" />
	    	</div><hr />
	    	
	      <div align='left' class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
		    	<div align ="center">
