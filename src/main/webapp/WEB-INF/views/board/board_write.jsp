...
<%
	...
	for(SmallcodeTO to : datas) {
		...
		String smallcode = to.getSmallcode();
		String smallinfo = to.getSmallinfo();
		if(smallcode.equals("BD001") || smallcode.equals("BD002") || smallcode.equals("BD098") || smallcode.equals("BD099")){
		}else{
...
<!-- 				<div class="form-group">
			...
			<button type="button" class="btn btn-secondary" onclick="location.href='./board.do'">취소</button>
		</form>
	</div>
<script>
	var oEditors = []; 
