...
<%	
	...
	for(BoardTO to : mainVOdatas) {
		...
		VOHtml.append( "<a style='color: black' href='./board_view.do?seq="+seq+"&id="+id+"&smallcode="+smallcode+"&loginUser="+loginUser+"'>" + title + "</a>" );
		VOHtml.append( "	</td>" );
		VOHtml.append("</tr>");
	...
	for(BoardTO to : mainSCdatas) {
		...
		SCHtml.append( "<a style='color: black' href='./board_view.do?seq="+seq+"&id="+id+"&smallcode="+smallcode+"&loginUser="+loginUser+"'>" + title + "</a>" );
		SCHtml.append( "	</td>" );
		SCHtml.append("</tr>");
	...
	for( leagueTO to : datas ) {
		...
		LEHtml.append("<a href='./club.do?teamname="+teamname+"'>");
	...
	for( newsTO to : datas4 ) {
		...
		NSHtml.append( " 								<button type='button' class='btn btn-sm btn-outline-secondary' onclick=location.href='./newsview.do?seq="+to.getSeq()+"'>View</button>");
		NSHtml.append( " 							</div>");
		NSHtml.append( " 				</div>");
		NSHtml.append( " 			</div>");
		NSHtml.append( " 		</div>"); 
	...
	<div align="middle">
		...
		<div style="width:1224px; height:700px; position: absolute; left: 77px; top: 398px; border :1px solid black;">
			 ...
			 <div style="margin : -620px 0px 0px 600px;">
			 	<a href="newsview.do?seq=19" style="color: black"><h4><%=newstitle %></h4></a>
			 	<h6><%=newswdate%></h6>
			 </div><br />
		...
		<div style="width:800px; height:550px; position: absolute; left: 1300px; top: 398px; border :1px solid black;">
			...
			<div style="margin:-30px 0px 0px 720px;"><a href="board.do?smallcode=BD098" style="color: black">MORE></a></div>
			<br /><hr />
		...
		<div style="width:1224px; height:700px; position: absolute; left: 77px; top: 1096px; border :1px solid black;">
			...
			<div style="margin:-30px 0px 0px 1100px;"><a href="newstemplate.do?classify=국내뉴스" style="color: black">MORE></a></div>
		...
		<div style="width:800px; height:550px; position: absolute; left: 1300px; top: 946px; border :1px solid black;">
			...
			<div style="margin:-30px 0px 0px 720px;"><a href="board.do?smallcode=BD003" style="color: black">MORE></a></div>
