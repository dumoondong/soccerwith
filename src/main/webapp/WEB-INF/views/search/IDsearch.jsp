...
<body>
    ...
    <div class="container" >
    		...
    		<div class="group" style="margin :0px 0px 150px 150px; border:0px solid; padding:100px">
    			<h2 style="margin-left: 0px; font-size:30px;" class="mt-4">아이디 찾기</h2>
				...
				<div class="row mb-3" >
					...
					<button style="color:white;" type="" id="" class="col-md-1 btn btn-dark">확인</button>
				</div>
				<br />
				<div class="row mb-3">
					<div style="background-color:white; border:0px; text-align:left;" class="col-md-2 btn btn-light"></div>
					<input type="hidden" name="" value="" />
					<input style="background-color:#e9e9e9; width:280px; border:1px solid; " name = "" placeholder="아이디출력" class="col-md-2 btn btn-light" type="text" >&nbsp&nbsp
				</div>
