...
<%
	ArrayList<newsTO> datas3 = (ArrayList)request.getAttribute( "datas3" );

	int totalRecord = datas3.size();
	...
	for( newsTO to : datas4 ) {
	    ...
	    sbHtml.append( " 								<button type='button' class='btn btn-sm btn-outline-secondary' onclick=location.href='./admnewsview.do?seq="+to.getSeq()+"'>View</button>");
	    sbHtml.append( " 							</div>");
	    sbHtml.append( " 				</div>");
	    sbHtml.append( " 			</div>");
	    sbHtml.append( " 		</div>"); 
...
<body>
    ...
    <div class="btn-group">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<input type="button" name="classify" value="해외뉴스" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='./admnewstemplate.do?classify=해외뉴스'" />
		<input type="button" name="classify" value="국내뉴스" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='./admnewstemplate.do?classify=국내뉴스'" />
		<input type="button" name="classify" value="은퇴선수" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='./admnewstemplate.do?classify=은퇴선수'" />
		<input type="button" name="classify" value="꿈나무들" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='./admnewstemplate.do?classify=꿈나무들'" />
	</div>
        	...
        	<div class="container">
             ...
             <div style="padding: 50px 0px 50px 1200px;">
             <button type="button" class="btn btn-secondary" onclick="location.href='newswrite.do'" >
           						글쓰기
           		</button>
           	</div>
        </div>
