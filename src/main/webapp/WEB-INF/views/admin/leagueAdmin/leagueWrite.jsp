...
<body>
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 g-3">
        <div class="col">
          <div class="card shadow-sm">
          	<div class="select_img">
          		<img style="margin-left : 20px; margin-top :30px;" align="center" src="" width="85%" height="200px" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
            		<div class="card-body">
              			<p class="card-text"></p>
        ...
        <form action="leagueWrite_ok.do" method="post" enctype = "multipart/form-data">
					      ...
					      <div class="modal-body">
						      <div style="width:900px;" class="modal-body">
							      <div class="row mb-3" >
										...
										<input style="background-color:white" name="teamname" class="col-md-7 themed-grid-col" type="text" >
									</div>

									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">창단년도</div>
										<input style="background-color:white" name="foundation" class="col-md-7 themed-grid-col" type="text" >
									</div>
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">연고지</div>
										<input style="background-color:white" name="hometown" class="col-md-7 themed-grid-col" type="text" >
									</div>
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">홈구장</div>
										<input style="background-color:white" name="homestadium" class="col-md-7 themed-grid-col" type="text" >
									</div>
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">닉네임</div>
										<input style="background-color:white" name="nickname" class="col-md-7 themed-grid-col" type="text" >
									</div>						
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">자국리그 우승</div>
										<input style="background-color:white" name="prewin" class="col-md-7 themed-grid-col" type="text" >
									</div>			
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">fa컵 우승</div>
										<input style="background-color:white" name="fawin" class="col-md-7 themed-grid-col" type="text" >
									</div>	
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">리그컵 우승</div>
										<input style="background-color:white" name="leaguewin" class="col-md-7 themed-grid-col" type="text" >
									</div>
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">챔스 우승</div>
										<input style="background-color:white" name="chamwin" class="col-md-7 themed-grid-col" type="text" >
									</div>
									
									<div class="row mb-3">
										<div class="col-md-5 themed-grid-col">유로파 우승</div>
										<input style="background-color:white" name="eurowin" class="col-md-7 themed-grid-col" type="text" >
									</div>
								...
								<%-- <%=request.getRealPath("/") %> --%>
									...
									<div style="width:900px;" class="row mb-3" >
										...
										<br /><br />
										<textarea class="form-control"  aria-label="Username" name="wri" id="smartEditor" rows="30" aria-describedby="basic-addon1"></textarea>
									</div>
									
									<!-- <div class="row mb-3" >
										<div class="col-md-5 themed-grid-col">리그</div>
										<input style="background-color:white" name="list" id="group" class="col-md-7 themed-grid-col" type="text" >
									</div> -->								
									
									<div class="modal-footer">
									<input type="submit" id="submit1" value="추가 "class="btn btn-primary"/>
									</div>	
								</div>
							</div>
