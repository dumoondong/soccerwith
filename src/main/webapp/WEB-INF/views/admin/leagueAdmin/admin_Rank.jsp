...
<body>
    ...
    <div class="container">
		<div class="btn-group btn-group-lg">
			<input type="button" value="클럽" class="btn btn-secondary my-2 my-sm-0" style="cursor: pointer;" onclick="location.href='./admin_league.do?smallcode=<%=listrank %>'" />
			<input type="button" value="역대기록" class="btn btn-secondary my-2 my-sm-0" style="cursor: pointer;" onclick="location.href='./admin_Record.do?list=<%=listrank %>'" />
		</div><hr />
