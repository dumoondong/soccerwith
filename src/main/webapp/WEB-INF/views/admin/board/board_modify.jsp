...
<body>
	...
	<div align="middle">
		...
		<form action="admin_board_modify_ok.do" method="post" name="mfrm" >
			...
			<button type="button" class="btn btn-secondary" onclick="location.href='./admin_board_view.do?seq=<%=seq%>'">취소</button>
		</form>
	</div>
<script>
var oEditors = []; 
