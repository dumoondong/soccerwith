    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 g-3">
        <div class="col">
          ...
          <br />
          <span align="center" style="font-size: 25px" class="txt_black">ManCity</span>
          <br />
          <img src="images/mancity.jpg" width="95%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em"></text></svg>
            <div class="card-body">
              <p class="card-text"></p>
        ...
        <div class="rightBox">
			<table class="arsernaltable" border="0" cellspacing="0" cellpadding="0" border-collapse="collapse">
				...
				<tbody>
					<tr>
						<th>창단년도</th>
						<td>&nbsp&nbsp&nbsp&nbsp1880년</td>
					</tr>
					<tr>
						<td>&nbsp</td>
					</tr>
					...
					<tr>
						<th>홈구장</th>
						<td>&nbsp&nbsp&nbsp&nbsp에티하드 스타디움</td>
					</tr>
					<tr>
						<td>&nbsp</td>
					</tr>
					<tr>
						<th>닉 네임</th>
						<td>&nbsp&nbsp&nbsp&nbspCitizens</td>
					</tr>
					<tr>
						<td>&nbsp</td>
					</tr>
