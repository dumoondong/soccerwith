...
public class AdminBoardController {
	...
	@RequestMapping( "admin_board.do" )	//리스트
	public ModelAndView board(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/board" );
		if(choice != null) {
	...
	@RequestMapping( "admin_board_write.do" )	//작성
	public ModelAndView board_write(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/board_write" );
		modelAndView.addObject( "datas", datas );
		return modelAndView;
	}
	@RequestMapping( "admin_board_write_ok.do" )	//작성확인
	public ModelAndView board_write_ok(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("admin/board/board_write_ok");
		modelAndView.addObject( "flag", flag );
		return modelAndView;
	}
	@RequestMapping( "admin_board_view.do" )	//뷰페이지
	public ModelAndView board_view(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/board_view" );
	...
	@RequestMapping( "admin_board_Recommend.do" )	//추천
	public ModelAndView board_Recommend(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/board_Recommend" );
		modelAndView.addObject( "flag", flag );
	...
	@RequestMapping( "admin_comment_Recommend.do" )	//댓글추천
	public ModelAndView comment_Recommend(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/comment_Recommend" );
		modelAndView.addObject( "flag", flag );
		modelAndView.addObject( "id", id );
	...
	@RequestMapping( "admin_comment_delete.do" )	//댓글삭제
	public ModelAndView comment_delete(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/comment_delete" );
		modelAndView.addObject( "flag", flag );
		modelAndView.addObject( "id", id );
		modelAndView.addObject( "pseq", pseq );
		modelAndView.addObject( "seq", seq );
	...
	@RequestMapping( "admin_board_cancel.do" )	//추천 취소
	public ModelAndView board_cancel(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/board_cancel" );
		modelAndView.addObject( "flag", flag );
		modelAndView.addObject( "id", id );
		modelAndView.addObject( "seq", seq );
		return modelAndView;
	...
	@RequestMapping( "admin_comment_cancel.do" )	// 댓글 추천 취소
	public ModelAndView comment_cancel(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/comment_cancel" );
		modelAndView.addObject( "flag", flag ); 
		modelAndView.addObject( "id", id );
		modelAndView.addObject( "seq", seq ); 
		modelAndView.addObject( "pseq", pseq ); 
	...
	@RequestMapping( "admin_board_modify.do" )	//수정페이지
	public ModelAndView board_modify(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView( "admin/board/board_modify" );
		modelAndView.addObject( "datas", datas );
		modelAndView.addObject( "to", to );
		modelAndView.addObject( "tosc", tosc ); // smallcode에 해당하는 코드정보
		return modelAndView;
	}
	@RequestMapping( "admin_board_modify_ok.do" )	//수정확인
	public ModelAndView board_modify_ok(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("admin/board/board_modify_ok");
		modelAndView.addObject( "flag", flag );
	...
	@RequestMapping( "admin_board_delete_ok.do" )	//삭제
	public ModelAndView board_delete_ok(HttpServletRequest request) {
		...
		ModelAndView modelAndView = new ModelAndView("admin/board/board_delete_ok");
		modelAndView.addObject( "flag", flag );
		return modelAndView;
	}
	
	@RequestMapping( "admin_comment_write_ok.do" )	//댓글작성
	public ModelAndView comment_write_ok(HttpServletRequest request) {
		...
		//System.out.println(smallcode);	
		ModelAndView modelAndView = new ModelAndView( "admin/board/comment_write_ok" );
		modelAndView.addObject( "flag", flag );
		modelAndView.addObject( "seq", seq );
		return modelAndView;
	}
